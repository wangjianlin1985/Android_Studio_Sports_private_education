...
public class StudentParentRegisterActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.studentparent_register); 
		ImageView search = (ImageView) this.findViewById(R.id.search);
		search.setVisibility(View.GONE);
		TextView title = (TextView) this.findViewById(R.id.title);
		title.setText("注册学生家长");
		...
		iv_studentPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(StudentParentRegisterActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_spUserName.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "用户名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_parentName.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "家长姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "手机号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_studentSex.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "学生性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_age.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "学生年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_school.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "学生学校输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(studentParent.getStudentPhoto() != null) {
						...
						StudentParentRegisterActivity.this.setTitle("正在上传图片，稍等...");
						String studentPhoto = HttpUtil.uploadFile(studentParent.getStudentPhoto());
						StudentParentRegisterActivity.this.setTitle("图片上传完毕！");
					...
					if(ET_studentDesc.getText().toString().equals("")) {
						Toast.makeText(StudentParentRegisterActivity.this, "学生介绍输入不能为空!", Toast.LENGTH_LONG).show();
					...
					studentParent.setShzt("待审核");
					 
					studentParent.setRegTime("--");
					/*调用业务逻辑层上传学生家长信息*/
					StudentParentRegisterActivity.this.setTitle("正在上传学生家长信息，稍等...");
