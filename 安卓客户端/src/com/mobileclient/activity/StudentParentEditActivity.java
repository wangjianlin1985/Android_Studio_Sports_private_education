			...
			public void onClick(View v) {
				try {
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_parentName.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "家长姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "手机号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_studentSex.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "学生性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_age.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "学生年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_school.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "学生学校输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if (!studentParent.getStudentPhoto().startsWith("upload/")) {
						...
						StudentParentEditActivity.this.setTitle("正在上传图片，稍等...");
						String studentPhoto = HttpUtil.uploadFile(studentParent.getStudentPhoto());
						StudentParentEditActivity.this.setTitle("图片上传完毕！");
						studentParent.setStudentPhoto(studentPhoto);
					} 
					/*验证获取学生介绍*/ 
					if(ET_studentDesc.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "学生介绍输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shzt.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "审核状态输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_regTime.getText().toString().equals("")) {
						Toast.makeText(StudentParentEditActivity.this, "注册时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传学生家长信息*/
					StudentParentEditActivity.this.setTitle("正在更新学生家长信息，稍等...");
