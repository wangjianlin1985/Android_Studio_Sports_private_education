			...
			public void onClick(View v) {
				try {
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_name.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sex.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_age.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "手机号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "价格(元/小时)输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if (!coach.getCoachPhoto().startsWith("upload/")) {
						...
						CoachEditActivity.this.setTitle("正在上传图片，稍等...");
						String coachPhoto = HttpUtil.uploadFile(coach.getCoachPhoto());
						CoachEditActivity.this.setTitle("图片上传完毕！");
						coach.setCoachPhoto(coachPhoto);
					} 
					/*验证获取教练简介*/ 
					if(ET_coachDesc.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "教练简介输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shzt.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "审核状态输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_regTime.getText().toString().equals("")) {
						Toast.makeText(CoachEditActivity.this, "注册时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传私教信息*/
					CoachEditActivity.this.setTitle("正在更新私教信息，稍等...");
