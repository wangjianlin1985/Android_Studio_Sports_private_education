...
public class StudentParentListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(StudentParentListActivity.this, StudentParentQueryActivity.class);
		...
		add_btn.setOnClickListener(new android.view.View.OnClickListener(){ 
			...
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(StudentParentListActivity.this, StudentParentAddActivity.class);
	...
	private void setViews() {
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new StudentParentSimpleAdapter(StudentParentListActivity.this, list,
		...
		lv.setOnItemClickListener(new OnItemClickListener(){
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
            	...
            	Intent intent = new Intent();
            	intent.setClass(StudentParentListActivity.this, StudentParentDetailActivity.class);
	...
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {  //编辑学生家长信息
			...
			Intent intent = new Intent();
			intent.setClass(StudentParentListActivity.this, StudentParentEditActivity.class);
			Bundle bundle = new Bundle();
			bundle.putString("spUserName", spUserName);
			intent.putExtras(bundle);
	...
	protected void dialog() {
		Builder builder = new Builder(StudentParentListActivity.this);
