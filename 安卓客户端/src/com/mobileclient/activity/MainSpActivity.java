...
public class MainSpActivity extends MyTabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TabSpec firstSpec = tabHost.newTabSpec(FIRST_TAB).setIndicator(FIRST_TAB)
				.setContent(new Intent(this, CoachSpListActivity.class));
		Button firstBtn = (Button)findViewById(R.id.firstBtn);
		firstBtn.setText("私教查询");
		/*第二tab页*/
		Declare declare = (Declare) this.getApplication();  
		Intent intent = new Intent();
		intent.setClass(this, StudentParentEditActivity.class);
		Bundle bundle = new Bundle();
		bundle.putString("spUserName", declare.getUserName());
