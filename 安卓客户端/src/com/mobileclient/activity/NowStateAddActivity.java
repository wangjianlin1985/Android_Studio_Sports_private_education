...
public class NowStateAddActivity extends Activity {
	// 声明确定添加按钮
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 设置当前Activity界面布局
		setContentView(R.layout.nowstate_add); 
			...
			public void onClick(View v) {
				try {
					...
					if(ET_stateName.getText().toString().equals("")) {
						Toast.makeText(NowStateAddActivity.this, "状态名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传现状态信息*/
					NowStateAddActivity.this.setTitle("正在上传现状态信息，稍等...");
					String result = nowStateService.AddNowState(nowState);
