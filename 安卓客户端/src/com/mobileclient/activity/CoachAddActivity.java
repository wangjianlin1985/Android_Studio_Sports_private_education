	...
	public void onCreate(Bundle savedInstanceState) {
		...
		iv_coachPhoto.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(CoachAddActivity.this,photoListActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if(ET_coachUserName.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "用户名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_name.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_sex.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "性别输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_age.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "手机号输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_price.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "价格(元/小时)输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(coach.getCoachPhoto() != null) {
						...
						CoachAddActivity.this.setTitle("正在上传图片，稍等...");
						String coachPhoto = HttpUtil.uploadFile(coach.getCoachPhoto());
						CoachAddActivity.this.setTitle("图片上传完毕！");
					...
					if(ET_coachDesc.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "教练简介输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shzt.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "审核状态输入不能为空!", Toast.LENGTH_LONG).show();
						ET_shzt.setFocusable(true);
						ET_shzt.requestFocus();
						return;	
					}
					coach.setShzt(ET_shzt.getText().toString());
					/*验证获取注册时间*/ 
					if(ET_regTime.getText().toString().equals("")) {
						Toast.makeText(CoachAddActivity.this, "注册时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传私教信息*/
					CoachAddActivity.this.setTitle("正在上传私教信息，稍等...");
