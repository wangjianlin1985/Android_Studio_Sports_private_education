			...
			public void onClick(View v) {
				try {
					...
					if(ET_startAge.getText().toString().equals("")) {
						Toast.makeText(AgeRangeAddActivity.this, "开始年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_endAge.getText().toString().equals("")) {
						Toast.makeText(AgeRangeAddActivity.this, "结束年龄输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_showText.getText().toString().equals("")) {
						Toast.makeText(AgeRangeAddActivity.this, "显示信息输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传年龄范围信息*/
					AgeRangeAddActivity.this.setTitle("正在上传年龄范围信息，稍等...");
