	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		register.setOnClickListener(new OnClickListener(){ 
			...
			public void onClick(View arg0) { 
				Intent intent = new Intent(LoginActivity.this,StudentParentRegisterActivity.class);
		...
		register2.setOnClickListener(new OnClickListener(){ 
			@Override
			public void onClick(View arg0) { 
				Intent intent = new Intent(LoginActivity.this,CoachRegisterActivity.class);
				startActivity(intent);
			} 
		});
		...
		identify_ShowText = new String[] {"学生家长","私教"};
		...
		Spinner_identify.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				...
				switch(arg2) {
					case 0:
						declare.setIdentify("sp");
						break;
					case 1:
						declare.setIdentify("coach");
						break;  
					default:
						break;
				} 
	...
	private Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case 1:
				...
				Declare declare = (Declare) LoginActivity.this.getApplication();
				if(declare.getIdentify().equals("coach"))
					intent.setClass(LoginActivity.this,MainCoachActivity.class);
				else
					intent.setClass(LoginActivity.this,MainSpActivity.class);
