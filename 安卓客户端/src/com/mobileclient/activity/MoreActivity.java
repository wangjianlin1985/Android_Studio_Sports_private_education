...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{/*"现状态","价格范围","年龄范围","普通管理员","修改个人信息",*/"关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				/*
				if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, NowStateListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, PriceRangeListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
					Intent intent  = new Intent(MoreActivity.this, AgeRangeListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 3){
					Intent intent  = new Intent(MoreActivity.this, ManagerListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 4){
