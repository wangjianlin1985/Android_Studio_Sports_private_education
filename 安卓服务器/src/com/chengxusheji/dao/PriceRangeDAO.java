...
public class PriceRangeDAO {
    ...
    /*根据主键获取对象*/
    @Transactional(propagation=Propagation.NOT_SUPPORTED)
    public PriceRange GetPriceRangeByPrId(int prId) {
        Session s = factory.getCurrentSession();
        PriceRange priceRange = (PriceRange)s.get(PriceRange.class, prId);
        return priceRange;
    }
    ...
    /*删除PriceRange信息*/
    public void DeletePriceRange (int prId) throws Exception {
        Session s = factory.getCurrentSession();
        Object priceRange = s.load(PriceRange.class, prId);
        s.delete(priceRange);
    }
